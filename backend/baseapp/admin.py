...
from .models import (Ad, Category, Popup, Post, Tags)
...
class PostAdmin(admin.ModelAdmin):
    ...
    fields = [
        'headline', 'featured_image', 'content', 'last_modified', 'categories', 'tags', 'author', 'status',
        'posted_on', 'posted_on_bs', 'views_count'
    ]
    readonly_fields = ['last_modified', 'posted_on_bs', 'author', 'views_count']
    list_display = [
        'headline', 'posted_on', 'last_modified', 'display_categories', 'author', "featured_image", 'status',
        'views_count'
    ]
